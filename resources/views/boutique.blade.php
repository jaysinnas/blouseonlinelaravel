    ...
    <section class="container my-4 ">
        <div class="row justify-content-center mb-5 mt-5 bg-success-subtle rounded">
            <div class="col-md-4 d-flex flex-column gap-4 mt-4 mb-4">
                <a href="{{ route('index') }}"><img class="shop-img" src="{{ asset('assets/images/boutique_images/dibya-bhattacharjee-BwZ5ptis1ik-unsplash.jpg') }}" alt="bhaterjee Sarees"></a>
                <a href="{{ route('index') }}"><img class="shop-img" src="{{ asset('assets/images/boutique_images/dollar-gill--B_mXm2zQDs-unsplash.jpg') }}" alt="Dollar Gill Sarees"></a>
                <a href="{{ route('index') }}"><img class="shop-img" src="{{ asset('assets/images/boutique_images/suits-me-online-_MrdhhuR26Q-unsplash.jpg') }}" alt="Suits Me Online"></a>
            </div>
        </div>

        <!-- TAILOR SHOP : en dessous de Boutique -->
        <div class="row justify-content-center p-5 bg-success-subtle rounded">
