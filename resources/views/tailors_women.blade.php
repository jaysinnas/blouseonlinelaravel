...
@section('content')
    ...
    <section class="container my-5 p-5 bg-danger-subtle rounded shadow-lg">
        <h2 class="text-center text-success fs-1 mb-5" style="font-family:Oleo Script, system-ui; ">Women Tailors</h2>
            <div class="d-flex justify-content-center gap-3">
                <div>
                    <img src="{{ asset('assets/images/womentailor/woman_tailor-1.jpg') }}" alt="Golden Aari Blouse"   class="img-fluid me-5 mb-4 rounded" style="width: 400px; height: auto;" >
                </div>
                <div>
                    <img src="assets/images/womentailor/woman-tailor-2.jpg" alt="Meroon Aari blouse"   class="img-fluid me-5 mb-4 rounded" style="width: 400px; height: auto;"> 
                </div>
                <div>
                    <img src="assets/images/womentailor/woman-tailor-3.jpg" alt="Merron Aari back"   class="img-fluid me-5 rounded mb-4" style="width: 400px; height: auto;">
                </div>
                <div>
                    <img src="assets/images/womentailor/woman_tailor-4.jpg" alt="Green and Red blouse"   class="img-fluid me-5 rounded mb-4" style="width: 400px; height: auto;">
                </div>
            </div>
    </section>
    <section>
        ...
        <div class="row justify-content-center bg-success-subtle p-5 ">
            <div class="col-md-8 shop-container text-center">
                ...
                <div class="d-flex flex-column flex-md-row align-items-center justify-content-center gap-5">
                    <div class="tailor_Shop mb-4 mb-md-0">
                ...
                <div class="d-flex justify-content-center gap-3 mt-4 flex-wrap">
                    ...
                    <a href="{{ route('tailoringboutique') }}"><button type="button" class="btn btn-primary">Visit Store</button></a>
                </div>
            </div>
        </div> 
    </section>
