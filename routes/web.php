...
Route::get('/trendy/{category}', [ProductController::class, 'trendyCategory'])->name('trendy.category');


Route::get('/trendy/{category:slug}', [ProductController::class, 'trendyCategory'])->name('trendy.category');
Route::get('/trendy', [ProductController::class, 'trendySection'])->name('trendy.home');

Route::get('/trendy', [ProductController::class, 'trendySection'])->name('trendy.index');

Route::get('/trendy/{category}', [ProductController::class, 'trendyCategory'])->name('trendy.category');
Route::get('/trendy/{slug}', [ProductController::class, 'category'])->name('trendy.category');


// If you are using ID in the URL
// Route::get('/trendy/category/{category}', [ProductController::class, 'trendyCategory'])->name('trendy.category');

// OR if you are using Slug (recommended for SEO)
// Route::get('/trendy/category/{category:slug}', [ProductController::class, 'trendyCategory'])->name('category.show');
...
// Route::get('/trendy/{slug}', [ProductController::class, 'trendy'])->name('trendy.index');
